...
Нужен Telegram-бот, который будет искать сообщения в моём канале по категориям и ключевым словам (например: хэштеги, названия категорий, фразы).
Бот должен уметь получать сообщения из...
